...
class personalspeciality {

    // table name
    protected static $table_name = "personal_specialities";
    // db connection
    private $conn;
    //db fileds
    protected static $db_fields = array('personal_record_id','specility_id');
    public $pk_id;
