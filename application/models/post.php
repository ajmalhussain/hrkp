...
class post {
    ...
    // table name
    protected static $table_name = "posts_record";
    // db connection
    private $conn;
    //db fileds
    protected static $db_fields = array('name', 'designation', 'bps');
    public $pk_id;
    public $name;
    public $designation;
    public $bps;
    ...
    public function find_by_id($id = 0) {
	 ...
	 $sql =  "SELECT * FROM `posts_record` ";
         
         return $this->conn->query($sql);	
}
    
            public function selectdata2($post_id=null){
