...
class family{
    ...
    // table name
    protected static $table_name = "family_record";
    // db connection
    private $conn;
    //db fileds
    protected static $db_fields = array('personal_record_id', 'spouse_id', 'health_professional');
    public $personal_personal_id;
    public $spouse_id;
 ...
 public function selectdata3($family_id=null){
    ...
    public function find_by_personal($id = 0) {
        ...
        $strSql = "SELECT
            family_record.pk_id,
	family_record.personal_record_id,
	family_record.spouse_id,
        family_record.health_professional
FROM
	family_record
WHERE
