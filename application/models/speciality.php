...
class speciality extends Base_model {

    // table name
    protected static $table_name = "specialities_record";
    // db connection
    private $conn;
    //db fileds
    protected static $db_fields = array('specility','is_active');
    public $pk_id;
    public $specility;
    public $is_active;
    ...
    public function find_all() {
        if ($_SESSION['role'] == 1) {
            return $this->query("SELECT * FROM " . static::$table_name. " where is_active = 1 ORDER BY specility");
    ...
    public function specilitydropdown(){
    
	 $sql =  "SELECT * FROM `specialities_record` ";
