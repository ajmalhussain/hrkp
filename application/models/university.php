...
class university extends Base_model {

    // table name
    protected static $table_name = "universities_record";
    // db connection
    private $conn;
    //db fileds
    protected static $db_fields = array('university_name', 'city', 'login_id', 'country','is_active');
...
//           return $this->query("SELECT * FROM " . static::$table_name);
               $strSql = "SELECT * FROM " . static::$table_name. " where is_active = 1 ORDER BY university_name" ;
...
//            return $this->query("SELECT * FROM " . static::$table_name );
    ...
    public function find_by_id($id = 0) {
	 ...
	 $sql =  "SELECT * FROM `universities_record` WHERE is_active = 1 ORDER BY university_name";
