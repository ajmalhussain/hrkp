...
class school extends Base_model {

    // table name
    protected static $table_name = "schools_record";
    // db connection
    private $conn;
    //db fileds
    protected static $db_fields = array('school_name', 'child_id');
    public $pk_id;
    public $school_name;
    public $child_id;
    ...
    public function find_by_id($id = 0) {
        ...
        public function selectdata5($school_id=null){
