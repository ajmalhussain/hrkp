...
class cadre extends Base_model {

    // table name
    protected static $table_name = "cadre_record";
    // db connection
    private $conn;
    //db fileds
    protected static $db_fields = array('cadre_value', 'login_id','is_active');
...
//           return $this->query("SELECT * FROM " . static::$table_name);
               $strSql = "SELECT * FROM " . static::$table_name. " where is_active = 1 ORDER BY cadre_value" ;
...
//            return $this->query("SELECT * FROM " . static::$table_name );
    ...
    public function find_by_id($id = 0) {
        ...
        public function cadredropdown(){
    
	 $sql =  "SELECT * FROM `cadre_record` WHERE is_active = 1 ORDER BY cadre_value";
