                    ...
                    while ($row = $result->fetch_array()) {
                        ...
                        <tr class="<?php echo $class; ?>">
                            ...
                            <td class="center" style="width: 200px;">
                                ...
                                <a onclick="return confirm('Are you sure you want to <?php echo ($row['is_active'] == 0 ? 'activate' : 'delete'); ?>?');" href="delete_category.php?id=<?php echo $row['pk_id']; ?>&is_active=<?php echo ($row['is_active'] == 1 ? '0' : '1'); ?>" class="btn-action glyphicons bin" ><i></i></a>
...
<form class="form-horizontal" enctype="multipart/form-data" style="margin-bottom: 0;" id="validateSubmitForm" method="post" autocomplete="off" action="add_category.php">
            ...
            <div class="row-fluid">
                ...
                <div class="span12">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls"><input class="span12" id="category_value" name="category_value" type="text" /></div>
                    </div>                         
