...
<div id="content">
    ...
    <div class="heading-buttons">
        ...
        <div class="buttons pull-right">
            ...
            <a href="<?php echo base_url("posting_place/export_excel") ?>" class="btn btn-primary btn-icon glyphicons download"><i></i>Export to Excel</a>
        </div>
...
<form class="form-horizontal" enctype="multipart/form-data" style="margin-bottom: 0;" id="validateSubmitForm" method="post" autocomplete="off" action="<?php echo base_url("posting_place/add"); ?>">
