...
<div id="content">
    <!-- Breadcrumb -->
    <ul class="breadcrumb">
        <li><a href="<?php echo base_url("category_management/index"); ?>" class="glyphicons home"><i></i> Home</a></li>
        <li class="divider"></li>
        <li>Manage HR</li>
    </ul>
                   ...
                   foreach ($data as $row) {
                       ...
                       if ($count % 2 == 0) {
                        ...
                        <tr class="<?php  echo $class; ?>">
                            ...
                            <td><?php  echo $row['cadre_value']; ?></td>                         
                            <td class="center" style="width: 200px;">
                                <a href="#edit" data-toggle="modal" id="<?php  echo $row['pk_id']; ?>-cid" class="btn-action glyphicons pen" title="edit"><i></i></a>
                                <a onclick="return confirm('Are you sure you want to <?php // echo ($row['is_active'] == 0 ? 'activate' : 'delete'); ?>?');" href="delete_cadre.php?id=<?php // echo $row['pk_id']; ?>&is_active=<?php // echo ($row['is_active'] == 1 ? '0' : '1'); ?>" class="btn-action glyphicons bin" ><i></i></a>
...
<form class="form-horizontal" enctype="multipart/form-data" style="margin-bottom: 0;" id="validateSubmitForm" method="post" autocomplete="off" action="<?php echo base_url("cadre_management/add"); ?>">
            ...
            <div class="row-fluid">
                ...
                <div class="span12">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls"><input class="span12" id="cadre_value" name="cadre_value" type="text" /></div>
                    </div>                         
...
<form class="form-horizontal" enctype="multipart/form-data" style="margin-bottom: 0;" id="validateSubmitForm" method="post" autocomplete="off" action="add_cadre.php">
