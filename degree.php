                    ...
                    while ($row = $result->fetch_array()) {
                        ...
                        <tr class="<?php echo $class; ?>">
                            ...
                            <td class="center" style="width: 200px;">
                                ...
                                <a onclick="return confirm('Are you sure you want to <?php echo ($row['is_active'] == 0 ? 'activate' : 'delete'); ?>?');" href="delete_degree.php?id=<?php echo $row['pk_id']; ?>&is_active=<?php echo ($row['is_active'] == 1 ? '0' : '1'); ?>" class="btn-action glyphicons bin" ><i></i></a>
